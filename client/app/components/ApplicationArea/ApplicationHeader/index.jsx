        ...
        <Menu mode="horizontal" selectable={false}>
          {currentUser.hasPermission("list_dashboards") && (
            <Menu.Item key="dashboards" className="dropdown-menu-item">
              <Button href="dashboards">仪表盘</Button>
              ...
              <Menu>
                {currentUser.hasPermission("create_query") && (
                  <Menu.Item key="new-query">
                    <a href="queries/new">新的查询</a>
                  </Menu.Item>
                )}
                {currentUser.hasPermission("create_dashboard") && (
                  <Menu.Item key="new-dashboard">
                    <a onMouseUp={showCreateDashboardDialog}>新的仪表盘</a>
                  </Menu.Item>
                )}
                {currentUser.hasPermission("list_alerts") && (
                  <Menu.Item key="new-alert">
                    <a href="alerts/new">新的提醒</a>
                  </Menu.Item>
                )}
              </Menu>
            }>
                ...
                <Menu>
                  ...
                  {currentUser.hasPermission("create_query") && (
                    <Menu.Item key="snippets">
                      <a href="query_snippets">查询</a>
                    </Menu.Item>
                  )}
                  {currentUser.isAdmin && (
                    <Menu.Item key="destinations">
                      <a href="destinations">提醒</a>
                    </Menu.Item>
                  )}
                  {currentUser.hasPermission("super_admin") && <Menu.Divider />}
